...
**Interpretive note:** CON-DI-006 derives its bidirectional constraint ("all revoked, and no others") from REQ-CP-006's "containing … all revoked certificates" combined with the logical implication that non-revoked certificates have no place in a CRL. This is a faithful reading of the requirement, not an invention.
